        ...
        <div className="bg-white border-2 border-black max-w-4xl w-full max-h-[90vh] overflow-y-auto">
          ...
          <div className="p-6">
            ...
            <p className="text-sm text-gray-600 mb-4">
              Globale statistieken van alle productvergelijkingen die gebruikers
              hebben uitgevoerd. Deze cijfers tonen hoeveel er potentieel kan
              worden bespaard door prijzen tussen landen te vergelijken.
            </p>
            ...
            <div className="mb-6">
              ...
              <p className="text-sm text-gray-600 mb-3">
                Het gemiddelde prijsverschil per product vergeleken met België.
                Groene waarden tonen hoeveel goedkoper het land is, rode waarden
                tonen hoeveel duurder.
              </p>
            ...
            <div className="mb-6">
              ...
              <p className="text-sm text-gray-600 mb-3">
                Hoe vaak elk land de goedkoopste of duurste prijs had in
                vergelijkingen. Dit geeft een indicatie van welke landen over
                het algemeen de beste prijzen bieden.
              </p>
              {countryStats.length > 0 ? (
                          ...
                          <div>
                            <div className="flex items-center justify-between text-xs mb-1">
                              ...
                              <span className="font-semibold text-red-700">
                                {Math.min(
                                  country.mostExpensivePercentage,
                                  100
                                ).toFixed(1)}
                                %
                              </span>
            ...
            <div className="mb-6">
              ...
              <p className="text-sm text-gray-600 mb-3">
                De producten met het grootste prijsverschil tussen landen. Deze
                producten zijn het meest de moeite waard om te vergelijken
                voordat je koopt.
              </p>
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="text-xs text-gray-600 mb-1">
                            {product.cheapestCountries &&
                              product.cheapestCountries.length > 0 && (
                                <span className="text-green-700">
                                  {countryNames[product.cheapestCountries[0]] ||
                                    product.cheapestCountries[0]}{' '}
                                  €{product.minPrice.toFixed(2)}
                                </span>
                              )}
                            {product.cheapestCountries &&
                              product.mostExpensiveCountries &&
                              product.cheapestCountries.length > 0 &&
                              product.mostExpensiveCountries.length > 0 &&
                              ' → '}
                            {product.mostExpensiveCountries &&
                              product.mostExpensiveCountries.length > 0 && (
                                <span className="text-red-700">
                                  {countryNames[
                                    product.mostExpensiveCountries[0]
                                  ] || product.mostExpensiveCountries[0]}{' '}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <div>
                ...
                <p className="text-sm text-gray-600 mb-3">
                  Hoeveel producten in alle landen beschikbaar zijn versus
                  slechts in sommige landen. Niet alle IKEA-producten zijn
                  overal verkrijgbaar.
                </p>
                <div className="space-y-3">
                  <div className="bg-white p-4 border-2 border-black">
                    ...
                    <div className="text-xs text-gray-600 mt-1">
                      {availabilityStats.percentageInAllCountries.toFixed(1)}%
                      van totaal
                    </div>
                  </div>
                  ...
                  <div className="bg-white p-4 border-2 border-black">
                    ...
                    <div className="text-xs text-gray-600 mt-1">
                      {(
                        100 - availabilityStats.percentageInAllCountries
                      ).toFixed(1)}
                      % van totaal
                    </div>
                  </div>
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 mb-3">
                  Het aantal unieke productvergelijkingen per land. Dit toont in
                  welke landen de meeste producten beschikbaar zijn.
                </p>
                <div className="space-y-2">
