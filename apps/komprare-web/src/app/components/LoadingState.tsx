    ...
    <div className="w-full max-w-4xl mx-auto flex flex-col items-center justify-center py-12 px-4">
      ...
      <div className="text-center space-y-3 max-w-xl">
        <h3 className="text-xl font-bold text-gray-900">
          Prijsinformatie ophalen...
        </h3>
        <p className="text-gray-600 leading-relaxed">
          We halen prijzen op van IKEA België, Nederland, Frankrijk en
          Duitsland. Dit kan even duren, vooral als je veel verschillende
          producten zoekt.
        </p>
        <p className="text-sm text-gray-500">Even geduld alsjeblieft...</p>
      </div>
    </div>
  );
}
