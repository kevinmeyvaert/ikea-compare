...
import { IkeaStore } from '@ikea-compare/types';
...
export default function StoreSettingsModal({
  ...
  const [netherlandsStore, setNetherlandsStore] = useState<IkeaStore | null>(
    null
  );
          ...
          <div className="p-6">
            <div className="mb-4">
              <p className="text-sm text-gray-700">
                Selecteer je voorkeurswinkel per land om beschikbaarheid te
                controleren
              </p>
            </div>
