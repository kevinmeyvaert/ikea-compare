...
import { trackProductComparison, trackShoppingListComparison } from '../lib/analytics/analytics-service';
...
function IndexContent() {
  ...
  const handlePDFUploadSuccess = useCallback(async (analysis: ShoppingListAnalysisType) => {
    setShoppingListAnalysis(analysis);
    setError(null);
