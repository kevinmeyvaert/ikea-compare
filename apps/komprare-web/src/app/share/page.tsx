...
function ShareContent() {
  ...
  const handleShareLinkSubmit = useCallback(
    async (shareLink: string) => {
      ...
      try {
        ...
        logAnalyticsEvent('share_link_analyzed', {
          product_count: analysis.products?.length || 0,
          total_items:
            analysis.products?.reduce(
        ...
        setError(
          err.message ||
            'Er is een fout opgetreden bij het verwerken van de share link'
        );
      } finally {
        setLoading(false);
      }
                ...
                <div className="bg-blue-50 border-2 border-ikea-blue p-6">
                  ...
                  <div className="mb-6">
                    ...
                    <ol className="text-sm text-gray-700 space-y-2 list-decimal list-inside ml-2">
                      ...
                      <li>
                        Open je <strong>winkelwagen</strong> en klik op de{' '}
                        <strong>...</strong>
                      </li>
                      <li>
                        Klik op de <strong>&ldquo;Deel&rdquo;</strong> knop
                      </li>
                  ...
                  <div className="mb-6">
                    <h4 className="text-sm font-bold text-gray-900 mb-2">
                      Via de IKEA mobiele app:
                    </h4>
                    <ol className="text-sm text-gray-700 space-y-2 list-decimal list-inside ml-2">
                      <li>Voeg producten toe aan je winkelwagen</li>
                      <li>
                        Open je <strong>winkelwagen</strong>
                      </li>
                      <li>
                        Klik op het <strong>deel-icoon</strong>
                      </li>
                      <li>Kopieer de gegenereerde share link</li>
                    </ol>
                  </div>
                  ...
                  <p className="text-sm text-gray-700 mb-4">
                    Plak de link in het invoerveld links en klik op{' '}
                    <strong>&ldquo;Vergelijk prijzen&rdquo;</strong>
                  </p>
